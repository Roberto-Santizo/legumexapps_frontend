          ...
          {plans.map((plan) => (
            <tr className="text-xl" key={plan.id}>
              ...
              <td className="record w-1/5">
                  <Link to={'/tareas-semanales'} className="button bg-indigo-500 hover:bg-indigo-600 w-auto">
                    Tareas del Plan
                  </Link>
              </td>
              <td className="record">
                  <Link to={'/tareas-semanales'} title="Reporte de Tareas General">
              ...
              <td className="record">
                  <Link to={'/tareas-semanales'} title="Reporte de Insumos">
                      <Sheet className="hover:text-gray-400"/>
                  </Link>
              </td>
            </tr>
