import { getSummaryDraftItems } from "@/api/DraftWeeklyProductionPlanAPI";
...
export default function SummaryItems({ filters }: Props) {
    ...
    const { data: items } = useQuery({
        queryKey: ['getSummaryDraftItems', id, filters.line],
        queryFn: () => getSummaryDraftItems({ id, line: filters.line }),
    ...
    if (items) return (
        <section className="bg-white p-6 rounded-2xl shadow-md border border-gray-200">
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-4">
                <h2 className="text-lg font-semibold text-gray-800">Material Empaque</h2>
