...
import { getPaginatedProveedor } from "@/api/BodegaProveedoresAPI";
...
export default function IndexProveedores() {
  ...
  return (
    <>
      <h1 className="font-bold text-3xl uppercase">Proveedores</h1>
      <div className="flex flex-col md:flex-row justify-end items-center gap-3 mt-10">
        <Link
          to="/proveedor/ingreso"
        ...
        >
          ...
          <p className="text-sm md:text-base">Registrar proveedores</p>
        </Link>
      </div>
