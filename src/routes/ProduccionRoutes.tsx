...
const routes = [
  { path: "/planes-produccion/crear", component: lazy(() => import("@/views/produccion/plans/Create")), roles: ['admin', 'audiproceso', 'logistics', 'adminprod', 'adminbodega', 'adminagricola'] },
  ...
  { path: "/planes-produccion/:plan_id/:linea_id", component: lazy(() => import("@/views/produccion/plans/ShowLineaDetalles")), roles: ['admin', 'audiproceso', 'logistics', 'adminprod', 'adminbodega', 'gerencia', 'adminagricola'] },
  { path: "/planes-produccion/asignacion/:plan_id/:linea_id/:task_p_id", component: lazy(() => import("@/views/produccion/plans/AsignarEmpleadosTareaProduccion")), roles: ['admin', 'audiproceso', 'adminagricola'] },
  ...
  { path: "/lineas/posiciones/:id", component: lazy(() => import("@/views/produccion/lines/Show")), roles: ['admin', 'pcostos', 'adminagricola'] },
  { path: "/lineas/crear", component: lazy(() => import("@/views/produccion/lines/Create")), roles: ['admin', 'pcostos', 'adminagricola'] },
  { path: "/lineas/editar/:id", component: lazy(() => import("@/views/produccion/lines/Edit")), roles: ['admin', 'pcostos', 'adminagricola'] },

  { path: "/lineas-skus", component: lazy(() => import("@/views/produccion/lines-performances/Index")), roles: ['admin', 'pcostos', 'adminagricola'] },
  { path: "/lineas-skus/crear", component: lazy(() => import("@/views/produccion/lines-performances/Create")), roles: ['admin', 'pcostos', 'adminagricola'] },

  { path: "/tiempos-muertos", component: lazy(() => import("@/views/produccion/timeouts/Index")), roles: ['admin', 'pcostos', 'adminagricola'] },
  { path: "/tiempos-muertos/crear", component: lazy(() => import("@/views/produccion/timeouts/Create")), roles: ['admin', 'pcostos', 'adminagricola'] },
  { path: "/tiempos-muertos/editar/:id", component: lazy(() => import("@/views/produccion/timeouts/Edit")), roles: ['admin', 'pcostos', 'adminagricola'] },
