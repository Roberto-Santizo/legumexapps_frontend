...
const routes = [
  ...
  { path: "/planes-semanales/planificacion-tareas/:plan_id/:finca_id", component: lazy(() => import("@/views/agricola/planes-semanales/PlanificacionPlanSemanal")), roles: ['admin', 'adminagricola', 'auxagricola'] },
