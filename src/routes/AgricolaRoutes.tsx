...
const routes = [
  ...
  { path: "/lotes", component: lazy(() => import("@/views/agricola/lotes/Index")), roles: ['admin', 'adminagricola', 'tehuya', 'alameda', 'linda', 'agricola'] },
  { path: "/lotes/checklist/:id", component: lazy(() => import("@/views/agricola/lotes/Checklist")), roles: ['admin', 'adminagricola', 'tehuya', 'alameda', 'linda', 'agricola'] },
  ...
  { path: "/cultivos", component: lazy(() => import("@/views/agricola/crops/views/crops/Index")), roles: ['admin', 'adminagricola'] },
  { path: "/cultivos/crear", component: lazy(() => import("@/views/agricola/crops/views/crops/Create")), roles: ['admin', 'adminagricola'] },
  { path: "/cultivos/partes/:id", component: lazy(() => import("@/views/agricola/crops/views/crop-parts/Index")), roles: ['admin', 'adminagricola'] },
  { path: "/cultivos/enfermedades/:id", component: lazy(() => import("@/views/agricola/crops/views/crop-diseases/Index")), roles: ['admin', 'adminagricola'] },
  { path: "/cultivos/enfermedades/:id/:diseaseId", component: lazy(() => import("@/views/agricola/crops/views/crop-diseases/Show")), roles: ['admin', 'adminagricola'] },
