...
export default function MenuTaskProductionActions({ task, setModalEntrega }: Props) {
    ...
    return (
        <Menu as="div" className="relative flex-none">
            ...
            >
                <MenuItems
                    className="absolute right-0 z-20 mt-2 md:w-96 w-40 origin-top-right rounded-2xl bg-white py-3 shadow-xl ring-1 ring-gray-900/10 focus:outline-none divide-y divide-gray-100"
                >
