            ...
            <div className="text-center">
              <div className="border-b border-black h-16 md:h-20 flex items-center justify-center">
                <img
                  ...
                  src={`${import.meta.env.VITE_AWS_BUCKET_URL}/storage/${transaction.delivered_by_signature}`}
          ...
          <div>
            ...
            <div className="text-center">
              <div className="border-b border-black h-16 md:h-20 flex items-center justify-center">
                <img
                  className="h-16 print:h-12"
                  src={`${import.meta.env.VITE_AWS_BUCKET_URL}/storage/${transaction.responsable_signature}`}
