...
export default function IngresoMaterialEmpaque() {
  return (
    <div>
      <div className="mt-12">
        <div className="shadow-xl p-10 bg-white rounded-lg w-full h-full">
          ...
          <div className="w-full flex flex-col md:flex-row justify-between">
            ...
            <div className="flex items-center gap-10">
              <div className="mt-16">
                <p className="font-bold uppercase">Fecha ingreso</p>
                <p className="font-bold uppercase mt-3">Fecha factura</p>
              </div>
              <div>
                <p className="uppercase text-center font-bold">R.pro.bod.06</p>
            ...
            <table className="border-collapse table-auto w-full">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="border border-black p-2 font-bold" colSpan={2}>Insertar dato acá</td>
                </tr>
                <tr>
                  <td></td>
                  <td></td>
          ...
          <div className="mt-12">
            <div className="font-bold uppercase mb-12">
              ...
              <p className="p-2 border-b border-black min-h-[6rem] font-normal">
                ...
                perferendis veniam nobis quo libero eveniet asperiores
                voluptatem aperiam pariatur quisquam modi quas quasi, porro quae
                laudantium! Corrupti modi asperiores deserunt!
              </p>
            </div>
          </div>
